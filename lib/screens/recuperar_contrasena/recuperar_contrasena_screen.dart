...
class _ScreenBodyState extends State<_ScreenBody> {
  ...
  Future<void> _sendRequest(BuildContext context) async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ResponseRecoverPass response =
            await InicioSesionRepository.sendRecoveryRequest(
        ...
        if (response.recoverStatus) {
          Navigator.of(context).pushAndRemoveUntil(
              MaterialPageRoute(
                  builder: (_) => RecuperarContrasenaExitoScreen()),
                ...
                if (errorMsg != null) ...[
                  ...
                  Container(
                    margin: EdgeInsets.symmetric(
                        vertical: 22.sp, horizontal: 33.sp),
