...
INSERT INTO tbl_usuarios (id_rol,  nombre, correo, pass, ciudadRecidencia, cumpleaños, activo, observaciones,
lugaresVisitados, porqueUnicab) 
VALUES (3, 'Gregory Figueredo', 'gregory.figueredo@unicab.org', '1QAZxsw2#', 'Sogamoso', '', 1, '', '', ''),
(3, 'Cristian Ortiz', 'cortiz@unicab.org', '1QAZxsw2#', 'Bogotá', '', 1, '', '', ''),
(3, 'Miguel Angel Ortiz', 'miguelangelortiz@unicab.org', '1QAZxsw2#', 'Bogotá', '', 1, '', '', '')
;