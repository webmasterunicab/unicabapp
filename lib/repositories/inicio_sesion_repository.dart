...
class InicioSesionRepository {
  static Future<ResponseRecoverPass> sendRecoveryRequest(String email) async {
    ...
    Uri url =
        Uri.https(ApiConfig.https, ApiConfig.recoverPassword, {'email': email});
  ...
  static Future<ResponseLogin> sendLoginRequest(String email, String password,
